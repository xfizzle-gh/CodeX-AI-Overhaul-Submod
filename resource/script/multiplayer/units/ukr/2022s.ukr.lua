...
local skirmish = {
	{
		...
		Units = {
			...
			{priority = 0.50, type = {"Infantry", "Team", "Engineer", "Support", "Class1"}, unit = "ukr_eng(ukr)"},
			{priority = 0.35, type = {"Infantry", "Team", "Recon", "Support", "Class1"}, unit = "ukr_scout(ukr)"},
			{priority = 0.32, type = {"Infantry", "Team", "AA", "Support", "Class1"}, unit = "ukr53_manpad(ukr)"},
			...
			{priority = 0.50, type = {"Infantry", "Team", "Engineer", "Support", "Class1"}, unit = "nato_eng(ukr)"},
			{priority = 0.35, type = {"Infantry", "Team", "Recon", "Support", "Class1"}, unit = "nato_scout(ukr)"},
			{priority = 0.32, type = {"Infantry", "Team", "AA", "Support", "Class1"}, unit = "nato_manpad(ukr)"},
