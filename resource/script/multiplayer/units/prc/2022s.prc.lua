...
local skirmish = {
	{
		...
		Units = {
			...
			{priority = 0.75, type = {"Infantry", "Team", "MG", "Support", "Class1"}, unit = "squad_pla112_mg(prc)"},
			{priority = 0.65, type = {"Infantry", "Team", "AT", "Support", "Class1"}, unit = "squad_pla112_pf98(prc)"},
			{priority = 1.0, type = {"Infantry", "Squad", "Class1"}, unit = "squad_pla112_rifle_dzj08(prc)"},
			{priority = 0.50, type = {"Infantry", "Team", "Recon", "Support", "Class1"}, unit = "squad_pla112_recon(prc)"},
