...
class AlliedSupportSharedFowAndGateTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.seed_probe_research_mode = 'PREFIX = "CODEX_MATE_SEED_PROBE"' in cls.attack_support_lua
        cls.research_mode = (
            cls.manual_research_mode
            or cls.native_spawn_research_mode
            or cls.seed_probe_research_mode
        )
    ...
    def test_attack_support_uses_routed_team_a_controller_owner(self) -> None:
        ...
        # can observe only the actor/context under study.
