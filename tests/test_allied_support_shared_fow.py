...
class AlliedSupportSharedFowAndGateTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.unitset_probe_research_mode = 'PREFIX = "CODEX_MATE_UNITSET_PROBE"' in cls.attack_support_lua
        cls.research_mode = (
            cls.manual_research_mode
            or cls.native_spawn_research_mode
            or cls.unitset_probe_research_mode
        )
