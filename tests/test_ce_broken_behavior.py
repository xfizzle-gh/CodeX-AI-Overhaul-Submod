...
class CeBrokenBehaviorTests(unittest.TestCase):
    ...
    def test_surrender_evacuates_to_captor_entry(self) -> None:
        ...
        self.assertGreaterEqual(evac.count("{drop orders}"), evac.count("{action move}"))
        ...
        self.assertIn("{time 3}", evac.rsplit("{action move}", 1)[1])
